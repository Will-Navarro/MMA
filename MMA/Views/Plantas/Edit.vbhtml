...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        @Html.HiddenFor(Function(model) model.PlantaID)
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.Detalle, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.Detalle, New With { .htmlAttributes = New With { .class = "form-control" } })
                @Html.ValidationMessageFor(Function(model) model.Detalle, "", New With { .class = "text-danger" })
            </div>
        </div>
